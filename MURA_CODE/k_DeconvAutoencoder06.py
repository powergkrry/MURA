...
#do i need this?
autoencoder.load_state_dict(torch.load('./pretrained/kang06_epoch9_model.pth.tar'))
optimizer.load_state_dict(torch.load('./pretrained/kang06_epoch9_optimizer.pth.tar'))
"""
