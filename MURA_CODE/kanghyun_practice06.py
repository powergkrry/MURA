...
#do i need this?
##autoencoder.load_state_dict(torch.load('./pretrained/kang06_epoch12_model.pth.tar'))
##optimizer.load_state_dict(torch.load('./pretrained/kang06_epoch12_optimizer.pth.tar'))
"""
...
#            break
    ...
    epoch_ = epoch + 0 + 1
    save_name_model = './pretrained/kang06_epoch' + str(epoch_) + '_model' + '.pth.tar'
    save_name_optimizer = './pretrained/kang06_epoch' + str(epoch_) + '_optimizer' + '.pth.tar'
